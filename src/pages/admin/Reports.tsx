      ...
      <div className="bg-white rounded shadow overflow-hidden">
        ...
        <table className="min-w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {invoices.map((inv) => (
              <tr key={inv.id}>
                <td className="px-6 py-4 whitespace-nowrap font-medium">{inv.invoiceNumber}</td>
                ...
                <td className="px-6 py-4 text-right">GHS {parseFloat(inv.totalAmount).toFixed(2)}</td>
              </tr>
            ))}
          </tbody>
        </table>
